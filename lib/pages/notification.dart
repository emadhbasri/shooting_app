  ...
  Widget build(BuildContext context) {
    return ListView.separated(
      padding: EdgeInsets.symmetric(
        ...
        separatorBuilder: (_,__)=>Divider(color: grayCall,),
...
class DataNotify{
  ...
  DataNotify({required this.person,required this.profileImage,
    required this.teamImage, required this.text, this.icon,
    required this.hasIcon, required this.time});
}