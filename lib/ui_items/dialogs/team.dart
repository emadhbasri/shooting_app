...
//             horizontal: doubleWidth(2), vertical: doubleHeight(1)),
//         children: [
//           SizedBox(
...
//                   TextSpan(
//                       text:
//                           '''These Terms and Conditions (this “Agreement”) constitute a legally binding agreement between You and GALLANT MEDIA LIMITED governing your use of the Football Buzz application and technology (collectively, the “Football Buzz Application).
...
// \n'''),
//                   TextSpan(
//                       text: 'Modification to the Agreement\n\n', style: bold),
//                   TextSpan(
//                       text:
...
//                   TextSpan(
//                       text:
//                           '''Football Buzz is an online social media platform for football fans. It provides micro blogging and messaging services to users.
...
//                   TextSpan(
//                       text: 'ELIGIBILITY AND ACCESS TO OUR SERVICES\n\n',
//                       style: bold),
//                   TextSpan(
//                       text:
//                           '''Our Application may only be used by individuals who can form legally binding contracts under applicable law. Our application is not available to children (persons under the age of majority in their jurisdiction or territory of residence)
...
// \n\n'''),
//                   TextSpan(
//                       text: 'THERE ARE OTHER TERMS THAT MAY APPLY TO YOU\n\n',
//                       style: bold),
//                   TextSpan(
//                       text:
...
// \n'''),
//                   TextSpan(
//                       text: 'WE MAY MAKE CHANGES TO OUR APPLICATION\n\n',
//                       style: bold),
//                   TextSpan(
//                       text:
//                           'We may update and change Our Application from time to time to reflect changes to Our Services, our Users’ needs and/or Our business priorities. We will try to give You reasonable notice of any major changes.\n'),
//                   TextSpan(
...
//                   TextSpan(
//                       text:
//                           'FOOTBALL BUZZ APPLICATION CONTENT AND USER INFORMATION',
//                       style: bold),
//                   TextSpan(
//                       text:
