...
class ProfileState extends ChangeNotifier {
  ...
  Future<void> getProfileShots({bool force = false}) async {
    ...
    Map<String, dynamic> back = await ShotsService.getByUsername(service,
        pageNumber: profilePostsPageNumber, username: userName);
  ...
  init(String username, context) async {
    ...
    if (personalInformation != null) {
      ...
      toast(AppLocalizations.of(context)!.user_not_found);
      Go.pop(context);
    }
  }
}
